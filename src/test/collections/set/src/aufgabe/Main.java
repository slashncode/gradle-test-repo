package test.collections.set.src.aufgabe;

import test.collections.set.src.main.collections.list.Cookbook;
import test.collections.set.src.main.collections.list.ListUtils;
import test.collections.set.src.main.collections.list.Recipe;
import test.collections.set.src.main.collections.map.MapUtils;
